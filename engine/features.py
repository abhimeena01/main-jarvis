...
def playAssistantSound():
    music_dir="C:\\Users\\DELL GUNA\\Desktop\\my minor project\\www\\assets\\audio\\start_sound.mp3"
    playsound(music_dir)
...
def PlayYoutube(query):
    from engine.command import speak  # Import speak at the start of the function
